...
mod tests{
    ...
    fn movement_serialization() {
        let movement = Movement {
            tx_hash: vec![158, 58, 146, 241, 218, 207, 194, 196, 103, 192, 89, 27, 56, 110, 195, 138, 29, 177, 167, 47, 144, 191, 102, 68, 45, 70, 88, 237, 140, 224, 130, 115],
            value: 500,
            block_hash: Some(vec![167, 131, 118, 190, 70, 199, 31, 2, 255, 135, 123, 36, 232, 182, 60, 178, 165, 110, 47, 11, 50, 1, 133, 106, 59, 195, 153, 210, 59, 21, 163, 41]),
        };
        ...
        assert_eq!(parsed_movement.tx_hash, vec![158, 58, 146, 241, 218, 207, 194, 196, 103, 192, 89, 27, 56, 110, 195, 138, 29, 177, 167, 47, 144, 191, 102, 68, 45, 70, 88, 237, 140, 224, 130, 115]);
        assert_eq!(parsed_movement.value, 500);
        assert_eq!(parsed_movement.block_hash, Some(vec![167, 131, 118, 190, 70, 199, 31, 2, 255, 135, 123, 36, 232, 182, 60, 178, 165, 110, 47, 11, 50, 1, 133, 106, 59, 195, 153, 210, 59, 21, 163, 41]));
    }
    ...
    fn wallet_history_serialization() {
        ...
        wallet.update_history(Movement { 
            tx_hash: vec![158, 58, 146, 241, 218, 207, 194, 196, 103, 192, 89, 27, 56, 110, 195, 138, 29, 177, 167, 47, 144, 191, 102, 68, 45, 70, 88, 237, 140, 224, 130, 115],
            value: 500,
            block_hash: Some(vec![167, 131, 118, 190, 70, 199, 31, 2, 255, 135, 123, 36, 232, 182, 60, 178, 98, 181, 242, 112, 111, 183, 22, 128, 11, 0, 0, 0, 0, 0, 0, 0]) });
        let serialized_wallet = wallet.serialize();
        let parsed_wallet = Wallet::parse_wallets(serialized_wallet).unwrap();
        assert_eq!(parsed_wallet[0].history[0].block_hash,
            Some(vec![167, 131, 118, 190, 70, 199, 31, 2, 255, 135, 123, 36, 232, 182, 60, 178, 98, 181, 242, 112, 111, 183, 22, 128, 11, 0, 0, 0, 0, 0, 0, 0]));
    }
    ...
    fn wallet_pubkey_hash() {
        ...
        assert_eq!(pubkey_hash,
            vec![132, 178, 35, 78, 47, 170, 110, 26, 117, 29, 126, 82, 132, 235, 16, 204, 230, 247, 81, 246]);
    }
    ...
    fn wallet_script_pubkey() {
        ...
        assert_eq!(script_pubkey,
            vec![118, 169, 20, 132, 178, 35, 78, 47, 170, 110, 26, 117, 29, 126, 82, 132, 235, 16, 204, 230, 247, 81, 246, 136, 172]);
    }
    ...
    fn wallet_privkey_hash() {
        ...
        assert_eq!(privkey_hash,
            vec![37, 40, 250, 211, 140, 107, 40, 1, 172, 178, 73, 96, 107, 232, 139, 51, 193, 141, 214, 94, 111, 179, 212, 131, 164, 214, 178, 10, 225, 183, 223, 54]);
    }
